...
type UserServerClient interface {
	GetUserInfo(ctx context.Context, in *GetUerInfoRequest, opts ...grpc.CallOption) (*GetUserInfoReply, error)
}
...
func (c *userServerClient) GetUserInfo(ctx context.Context, in *GetUerInfoRequest, opts ...grpc.CallOption) (*GetUserInfoReply, error) {
	out := new(GetUserInfoReply)
	err := c.cc.Invoke(ctx, "/user.v1.UserServer/GetUserInfo", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type UserServerServer interface {
	GetUserInfo(context.Context, *GetUerInfoRequest) (*GetUserInfoReply, error)
...
func (UnimplementedUserServerServer) GetUserInfo(context.Context, *GetUerInfoRequest) (*GetUserInfoReply, error) {
...
func _UserServer_GetUserInfo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/user.v1.UserServer/GetUserInfo",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServerServer).GetUserInfo(ctx, req.(*GetUerInfoRequest))
	}
...
var UserServer_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "user.v1.UserServer",
